  ...
  return (
    ...
    >
      <Card className="space-y-4">
        <div className="rounded-2xl border border-dashed border-[var(--ink-200)] bg-[var(--mist-100)] p-6 text-center">
          ...
          <button className="mt-4 rounded-full bg-[var(--ink-900)] px-4 py-2 text-xs font-semibold text-white">
            Upload files
          </button>
        </div>
